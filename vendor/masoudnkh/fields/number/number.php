 ...
 *
 */
if ( ! class_exists( 'AVAN_Field_number' ) ) {
  class AVAN_Field_number extends AVAN_Fields {
    ...
    public function render() {
      ...
      echo ( ! empty( $args['unit'] ) ) ? '<span class="avan--unit">'. esc_attr( $args['unit'] ) .'</span>' : '';
      echo '</div>';
