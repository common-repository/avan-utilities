 ...
 *
 */
if ( ! class_exists( 'AVAN_Abstract' ) ) {
  abstract class AVAN_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        AVAN::$css = apply_filters( "avan_{$this->unique}_output_css", AVAN::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'AVAN_Field_' . $field_type;
